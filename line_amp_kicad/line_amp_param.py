...
params = {
        ...
        'r1b': 100E3, #r1 in divider bias network
        'r2b': 100E3 #r2 in divider bias network
...
vin = 300E-3 #input voltage Vpp
vout = 3 #desired output voltage Vpp
...
def calc_rg(gain, rf): return 

#- Calculations

params['c_dcb'] = calc_dcb(params['r1b'], params['r2b'], fc_hpf)
params['rg'] = calc_rg(gain = vout / vin, params['rf']) 
